...
public class Main {
    ...
    public static void readObjectsFromFile() {
        try {
            ...
            Tiger loadedTiger = (Tiger) tigerIN.readObject();
            tigerIN.close();
            System.out.println("\n=== Loaded Tiger from tiger.txt ===");
            System.out.println("Name " + loadedTiger.getNameOfAnimal());
            System.out.println("Age " + loadedTiger.getAge());
            System.out.println("Height " + loadedTiger.getHeight());
            System.out.println("Weight " + loadedTiger.getWeight());
            System.out.println("Number of stripes " + loadedTiger.getNumberOfStripes());
            System.out.println("Speed " + loadedTiger.getSpeed());
            System.out.println("Sound level " + loadedTiger.getSoundLevel());

            ObjectInputStream penguinIN = new ObjectInputStream(new FileInputStream("penguin.txt"));
            Penguin loadedPenguin = (Penguin) penguinIN.readObject();
            penguinIN.close();
            System.out.println("\n=== Loaded Penguin from penguin.txt ===");
            System.out.println("Name " + loadedPenguin.getNameOfAnimal());
            System.out.println("Age " + loadedPenguin.getAge());
            System.out.println("Height " + loadedPenguin.getHeight());
            System.out.println("Weight " + loadedPenguin.getWeight());
            System.out.println("Swimming " + loadedPenguin.isSwimming());
            System.out.println("Walk Speed " + loadedPenguin.getWalkSpeed());
            System.out.println("Swim Speed " + loadedPenguin.getSwimSpeed());

            ObjectInputStream dolphinIN = new ObjectInputStream(new FileInputStream("dolphin.txt"));
            Dolphin loadedDolphin = (Dolphin) dolphinIN.readObject();
            dolphinIN.close();
            System.out.println("\n=== Loaded Dolphin from dolphin.txt ===");
            System.out.println("Name " + loadedDolphin.getNameOfAnimal());
            System.out.println("Age " + loadedDolphin.getAge());
            System.out.println("Height " + loadedDolphin.getHeight());
            System.out.println("Weight " + loadedDolphin.getWeight());
            System.out.println("Color " + loadedDolphin.getColor());
            System.out.println("Swimming Speed " + loadedDolphin.getSwimmingSpeed());
